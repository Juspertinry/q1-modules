...
if [ ! -e /sys/class/leds/red/brightness ]; then
    ...
    ui_print "! This module targets Quest headsets with the PMI8998 RGB LED."
...
# Quest LED settings. Reboot after editing, or restart the daemon:
#   pkill -f questled.sh && nohup sh /data/adb/modules/questled/questled.sh &
