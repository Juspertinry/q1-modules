...
is the release build. Stripping is line based and deliberately conservative:
  ...
  - tint.conf keeps everything, since that is the file you edit
...
MODULES = ["q1_led", "q1_ptcolor", "q1_audiofx", "q1_seperationanxiety", "q1_90hz"]

# Files whose comments are user-facing documentation, not implementation notes.
KEEP_COMMENTS = {"tint.conf"}

SHELL_NAMES = {"update-binary", "ptcolor"}
